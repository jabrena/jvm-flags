[Global flags]
    ...
    ccstr AllocateHeapAt                           =                                           {product} {default}
      ...
      int AllocatePrefetchDistance                 = 384                                       {product} {default}
     intx AllocatePrefetchInstr                    = 0                                         {product} {default}
      int AllocatePrefetchLines                    = 3                                         {product} {default}
      int AllocatePrefetchStepSize                 = 128                                       {product} {default}
...
ccstrlist CompileOnly                              =                                           {product} {default}
   ...
   size_t CompressedClassSpaceSize                 = 1073741824                                {product} {default}
    ...
    ccstr DumpLoadedClassList                      =                                           {product} {default}
     ...
     bool EagerJVMCI                               = true                                {JVMCI product} {ergonomic}
     ...
     bool EnableJVMCI                              = true                                {JVMCI product} {jimage}
 ...
 uint64_t ErrorLogTimeout                          = 120                                       {product} {default}
   ...
   double JVMCINativeLibraryThreadFraction         = 0.660000                            {JVMCI product} {default}
   ...
   size_t LargePageSizeInBytes                     = 0                                         {product} {default}
     bool LibJVMCICompilerThreadHidden             = true                                {JVMCI product} {default}
 ...
 uint64_t MaxRAM                                   = 137438953472                           {pd product} {default}
   ...
   size_t NewSizeThreadIncrease                    = 5320                                   {pd product} {default}
    ...
    uintx NonNMethodCodeHeapSize                   = 6406144                                {pd product} {ergonomic}
    uintx NonProfiledCodeHeapSize                  = 122634240                              {pd product} {ergonomic}
...
ccstrlist OnOutOfMemoryError                       =                                           {product} {default}
   ...
   size_t PretenureSizeThreshold                   = 0                                         {product} {default}
    ...
    uintx ProfiledCodeHeapSize                     = 122617856                              {pd product} {ergonomic}
   ...
   size_t SharedBaseAddress                        = 30786325577728                            {product} {default}
