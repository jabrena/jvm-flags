[Global flags]
    ...
    uintx AdaptiveTimeWeight                        = 25                                  {product}
     ...
     intx AllocatePrefetchDistance                  = 384                                 {product}
     intx AllocatePrefetchInstr                     = 0                                   {product}
     intx AllocatePrefetchLines                     = 3                                   {product}
     intx AllocatePrefetchStepSize                  = 128                                 {product}
    ...
    uintx AutoGCSelectPauseMillis                   = 5000                                {product}
     bool AvoidUnalignedAccesses                    = false                               {ARCH product}
    ...
    uintx BaseFootPrintEstimate                     = 268435456                           {product}
     ...
     intx BlockZeroingLowLimit                      = 256                                 {ARCH product}
...
ccstrlist CompileOnly                               =                                     {product}
   ...
   double InitialRAMPercentage                      = 1.562500                            {product}
    ...
    uintx MaxMetaspaceExpansion                     = 5439488                             {product}
    uintx MaxMetaspaceFreeRatio                     = 70                                  {product}
    uintx MaxMetaspaceSize                          = 18446744073709535232                    {product}
 ...
 uint64_t MaxRAM                                    = 137438953472                        {pd product}
   ...
   double MaxRAMPercentage                          = 25.000000                           {product}
    ...
    uintx MinMetaspaceExpansion                     = 327680                              {product}
   ...
   double MinRAMPercentage                          = 50.000000                           {product}
    ...
    ccstr NativeMemoryTracking                      = off                                 {product}
     bool NearCpool                                 = true                                {ARCH product}
    ...
    uintx NewSizeThreadIncrease                     = 5320                                {pd product}
     ...
     intx NmethodSweepFraction                      = 9                                   {product}
...
ccstrlist OnOutOfMemoryError                        =                                     {product}
    ...
    ccstr PerfDataSaveFile                          =                                     {product}
     ...
     intx PrefetchCopyIntervalInBytes               = 384                                 {product}
     intx PrefetchFieldsAhead                       = -1                                  {product}
     intx PrefetchScanIntervalInBytes               = 384                                 {product}
    ...
    uintx ReservedCodeCacheSize                     = 134217728                           {pd product}
    ...
    uintx SharedMiscCodeSize                        = 196608                              {product}
    ...
    ccstr TraceJVMTI                                =                                     {product}
     ...
     bool TraceTraps                                = false                               {ARCH product}
    ...
    uintx TypeProfileLevel                          = 111                                 {pd product}
     ...
     bool UseBarriersForVolatile                    = false                               {ARCH product}
     bool UseBiasedLocking                          = true                                {product}
     bool UseBimorphicInlining                      = true                                {C2 product}
     bool UseBlockZeroing                           = true                                {ARCH product}
     ...
     bool UseCRC32                                  = true                                {ARCH product}
     ...
     bool UseNeon                                   = false                               {ARCH product}
     ...
     bool UseSIMDForMemoryOps                       = false                               {ARCH product}
