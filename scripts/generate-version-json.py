...
EXTRA: dict[int, dict] = {
    8: {
        "nodes": [
            ...
            {"id": "gc-logging", "label": "Logging GC", "type": "subcategory", "parent": "garbage-collection"},
        ...
        "edges": [
            ...
            {"source": "garbage-collection", "target": "gc-logging"},
            ...
            {"source": "gc-logging", "target": "flag-verbosegc"},
            {"source": "gc-logging", "target": "flag-printgcdetails"},
            {"source": "gc-logging", "target": "flag-printgctimestamps"},
            {"source": "gc-logging", "target": "flag-xloggc"},
